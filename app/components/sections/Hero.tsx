    ...
    <>
      <div className="h-screen bg-[#131214] text-white relative overflow-hidden">
        ...
        <div className="absolute top-20 right-0 left-0 bottom-0 z-10 max-w-6xl mx-auto px-8 pt-32 pb-40 text-center">
          <div className="mb-8">
            <span className="px-6 py-2 border border-gray-700 rounded-full text-sm text-gray-300 inline-block">
          ...
          <p className="text-sm text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex items-center justify-center space-x-6">
            ...
            <button className="px-8 py-3 border border-gray-700 rounded-lg hover:border-gray-500 transition flex items-center space-x-2 group">
